                        ...
                        <div className="flex gap-3">
                            {rewards.primogems && (
                                <div className="flex items-center gap-1 text-xs bg-stone-200 px-2 py-1 rounded border border-black/5">
                                    <img src={`${import.meta.env.BASE_URL}images/rewards/primogems.png`} alt="Primogems" className="w-4 h-4 object-contain" />
                                    <span className="text-gray-700 font-medium">{rewards.primogems}</span>
                                </div>
                            )}
                            {rewards.mora && (
                                <div className="flex items-center gap-1 text-xs bg-stone-200 px-2 py-1 rounded border border-black/5">
                                    <img src={`${import.meta.env.BASE_URL}images/rewards/mora.png`} alt="Mora" className="w-4 h-4 object-contain" />
                            ...
                            {rewards.wishes && (
                                <div className="flex items-center gap-1 text-xs bg-stone-200 px-2 py-1 rounded border border-black/5">
                                    <img src={`${import.meta.env.BASE_URL}images/rewards/wishes.png`} alt="Wishes" className="w-4 h-4 object-contain" />
